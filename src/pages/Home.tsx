...
const Home = () => {
  ...
  const news = [
    { title: '從課堂到社區、從文學到科技—華語文學系「AI繪紅樓·紅樓會AI」展覽...', date: 'March 15, 2026', category: '[華語文學系]', image: campusHero, href: 'https://www.nqu.edu.tw/p/406-1000-21503,r11.php?Lang=zh-tw' },
    { title: '高粱田黑化像燒焦! 金門大學「空中救援」，幫農民應戰氣候變遷', date: 'March 10, 2026', category: '[國立金門大學]', image: globalImage, href: 'https://www.nqu.edu.tw/p/406-1000-21495,r11.php?Lang=zh-tw' },
    { title: '「Autodesk創意設計競賽」 金大3學子勇奪金獎', date: 'March 8, 2026', category: '[國立金門大學]', image: collabImage, href: 'https://www.nqu.edu.tw/p/406-1000-21487,r11.php?Lang=zh-tw' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-16">
            <div>
              ...
              <a href="https://www.nqu.edu.tw/p/403-1000-120.php?Lang=zh-tw" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center space-x-2 text-slate-600 dark:text-slate-300 font-bold hover:text-nqu-purple transition-colors">
                <Calendar size={20} />
